...
const invoiceReq = (renderer) => {
  const invoice_options =
  {
    ...
    "footer": {
      "height": "32mm",
      "contents": "<div style='color:#444;'><div style='Float:left;text-align:left;'>Clanbeat Inc <br />548 Market st. 63570 <br />San Fransisco, Ca 94104 <br /></div><div style='float:right;text-align:right;vertical-align:bottom;margin-top:25px;'>www.clanbeat.com</div></div>"
    },
  };
  const getFn = (req, res) => {
